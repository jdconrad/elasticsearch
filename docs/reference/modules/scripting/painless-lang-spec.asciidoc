...
A compound assignment is --the expression below where V is the variable/member and T is the type of variable/member.
...
b |= true;          // ors be with true -- b = (boolean)(b | true)
