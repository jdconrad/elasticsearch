...
public class DenseVectorFieldMapper extends FieldMapper {
    ...
    public enum ElementType {
        ...
        BYTE(1) {
            ...
            @Override
            public void putValue(ByteBuffer byteBuffer, float value) {
        ...
        public abstract void putValue(ByteBuffer byteBuffer, float value);

        public abstract float getValue(ByteBuffer byteBuffer);
    }
    ...
    private class DocValuesSyntheticFieldLoader implements SourceLoader.SyntheticFieldLoader {
        ...
        public void write(XContentBuilder b) throws IOException {
            ...
            for (int dim = 0; dim < dims; dim++) {
                b.value(elementType.getValue(byteBuffer));
            }
            b.endArray();
        }
    }
