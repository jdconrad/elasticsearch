...
public class NeedsScoreTests extends ESSingleNodeTestCase {
    ...
    public void testNeedsScores() {
        ...
        Map<ScriptContext<?>, List<Whitelist>> contextsMap = new HashMap<>();
        contextsMap.put(SearchScript.CONTEXT, BASE_WHITELISTS);
        contextsMap.put(ExecutableScript.CONTEXT, BASE_WHITELISTS);
        PainlessScriptEngine service = new PainlessScriptEngine(Settings.EMPTY, contextsMap);
