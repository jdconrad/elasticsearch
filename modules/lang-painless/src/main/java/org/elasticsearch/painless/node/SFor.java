...
public class SFor extends AStatement {
    ...
    Output analyze(ClassNode classNode, ScriptRoot scriptRoot, Scope scope, Input input) {
        ...
        output.statementNode = new ForLoopNode()
                ...
                .setConditionNode(condition == null ? null : condition.cast(conditionOutput))
                .setAfterthoughtNode(afterthought == null ? null : afterthought.cast(afterthoughtOutput))
