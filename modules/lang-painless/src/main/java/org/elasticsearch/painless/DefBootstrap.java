...
public final class DefBootstrap {
    ...
    static final class PIC extends MutableCallSite {
        ...
        PIC(PainlessLookup painlessLookup, FunctionTable table,
        ...
        private MethodHandle lookup(int flavor, String name, Class<?> receiver) throws Throwable {
            switch(flavor) {
                case METHOD_CALL:
                    return Def.lookupMethod(painlessLookup, table, methodHandlesLookup, type(), receiver, name, args);
                case LOAD:
                ...
                case REFERENCE:
                    return Def.lookupReference(painlessLookup, table, methodHandlesLookup, (String) args[0], receiver, name);
    ...
    public static CallSite bootstrap(PainlessLookup painlessLookup, FunctionTable table,
            MethodHandles.Lookup methodHandlesLookup, String name, MethodType type, int initialDepth, int flavor, Object... args) {
        // validate arguments
        switch(flavor) {
            ...
            case METHOD_CALL:
                ...
                return new PIC(painlessLookup, table, methodHandlesLookup, name, type, initialDepth, flavor, args);
            case LOAD:
            case STORE:
            case ARRAY_LOAD:
            case ARRAY_STORE:
