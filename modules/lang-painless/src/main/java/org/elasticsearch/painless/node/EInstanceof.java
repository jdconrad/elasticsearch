...
public final class EInstanceof extends AExpression {
    ...
    void analyze(Locals locals) {
        ...
        resolvedType = clazz.isPrimitive() ? Definition.getBoxedType(clazz) : Definition.convertPainlessTypeToJavaType(clazz);
        ...
        expressionType = expression.actual.isPrimitive() ?
            Definition.getBoxedType(expression.actual) : Definition.convertPainlessTypeToJavaType(clazz);
