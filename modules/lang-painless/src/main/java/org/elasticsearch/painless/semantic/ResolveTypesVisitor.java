...
package org.elasticsearch.painless.semantic;
...
public class ResolveTypesVisitor implements ASTVisitor {
    ...
    private void buildVisitors() {
        visitors.put(DUnresolvedType.class, (node, lookup) -> {
            DUnresolvedType unresolvedType = (DUnresolvedType)node;
            Class<?> type = lookup.canonicalTypeNameToType(unresolvedType.getUnresolvedType());
