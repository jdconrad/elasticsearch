...
public final class CompilerSettings {
     ...
     */
    /**
     * Whether a simple boolean ingest condition may be represented as a
     * {@link ConditionProgram} instead of being compiled to a class. Node scope, because it changes
     * whether a script class exists at all and so cannot be flipped against an already-populated cache.
     * Provided as an escape hatch: disabling it restores the previous compile-everything behaviour.
     */
    public static final Setting<Boolean> CONDITION_PROGRAMS_ENABLED = Setting.boolSetting(
        "script.painless.condition_programs.enabled",
        true,
        Property.NodeScope
    );
