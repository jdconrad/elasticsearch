...
public final class WriterConstants {
    ...
    public static final String BASE_INTERFACE_NAME = JavascriptScript.class.getName();
    public static final Type BASE_INTERFACE_TYPE = Type.getType(JavascriptScript.class);
    ...
    /**
     * A Method instance for {@linkplain Pattern}. This isn't available from JavascriptLookup because we intentionally don't add it
