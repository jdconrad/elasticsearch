...
interface JavascriptParserVisitor<T> extends ParseTreeVisitor<T> {
   ...
   * @return the visitor result
   */
  T visitLambdaval(JavascriptParser.LambdavalContext ctx);
  /**
   * Visit a parse tree produced by the {@code funcrefval}
   * labeled alternative in {@link JavascriptParser#expression}.
   * @param ctx the parse tree
   * @return the visitor result
   */
  T visitFuncrefval(JavascriptParser.FuncrefvalContext ctx);
  /**
