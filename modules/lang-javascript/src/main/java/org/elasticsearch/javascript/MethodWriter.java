...
import static org.elasticsearch.javascript.WriterConstants.DEF_TO_B_BYTE_IMPLICIT;
import static org.elasticsearch.javascript.WriterConstants.DEF_TO_B_CHARACTER_EXPLICIT;
import static org.elasticsearch.javascript.WriterConstants.DEF_TO_B_CHARACTER_IMPLICIT;
import static org.elasticsearch.javascript.WriterConstants.DEF_TO_B_DOUBLE_EXPLICIT;
import static org.elasticsearch.javascript.WriterConstants.DEF_TO_B_DOUBLE_IMPLICIT;
import static org.elasticsearch.javascript.WriterConstants.DEF_TO_B_FLOAT_EXPLICIT;
import static org.elasticsearch.javascript.WriterConstants.DEF_TO_B_FLOAT_IMPLICIT;
import static org.elasticsearch.javascript.WriterConstants.DEF_TO_B_INTEGER_EXPLICIT;
import static org.elasticsearch.javascript.WriterConstants.DEF_TO_B_INTEGER_IMPLICIT;
import static org.elasticsearch.javascript.WriterConstants.DEF_TO_B_LONG_EXPLICIT;
...
import static org.elasticsearch.javascript.WriterConstants.DEF_TO_P_CHAR_EXPLICIT;
import static org.elasticsearch.javascript.WriterConstants.DEF_TO_P_CHAR_IMPLICIT;
import static org.elasticsearch.javascript.WriterConstants.DEF_TO_P_DOUBLE_EXPLICIT;
import static org.elasticsearch.javascript.WriterConstants.DEF_TO_P_DOUBLE_IMPLICIT;
import static org.elasticsearch.javascript.WriterConstants.DEF_TO_P_FLOAT_EXPLICIT;
import static org.elasticsearch.javascript.WriterConstants.DEF_TO_P_FLOAT_IMPLICIT;
import static org.elasticsearch.javascript.WriterConstants.DEF_TO_P_INT_EXPLICIT;
import static org.elasticsearch.javascript.WriterConstants.DEF_TO_P_INT_IMPLICIT;
import static org.elasticsearch.javascript.WriterConstants.DEF_TO_P_LONG_EXPLICIT;
...
public final class MethodWriter extends GeneratorAdapter {
    ...
    public void writeLoopCounter(int slot, Location location) {
        ...
        throwException(JAVASCRIPT_ERROR_TYPE, "The maximum number of statements that can be executed in a loop has been reached.");
        mark(end);
    }

    public void writeCast(JavascriptCast cast) {
        if (cast == null) {
            return;
        }
    ...
    public void invokeMethodCall(JavascriptMethod javascriptMethod) {
        Type type = Type.getType(javascriptMethod.javaMethod().getDeclaringClass());
        Method method = Method.getMethod(javascriptMethod.javaMethod());

        if (Modifier.isStatic(javascriptMethod.javaMethod().getModifiers())) {
            ...
            if (javascriptMethod.javaMethod().getDeclaringClass().isInterface()) {
                visitMethodInsn(
        ...
        } else if (javascriptMethod.javaMethod().getDeclaringClass().isInterface()) {
