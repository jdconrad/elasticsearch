...
/**
 * A lexer that is customized for javascript. It:
 * <ul>
 ...
 * </ul>
 */
final class EnhancedJavascriptLexer extends JavascriptLexer {
    private final String sourceName;
    private Token current = null;

    EnhancedJavascriptLexer(CharStream charStream, String sourceName) {
        super(charStream);
