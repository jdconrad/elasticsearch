...
public class JavascriptParser extends JavascriptParserBase {
    ...
    public static final int HashBangLine = 1, MultiLineComment = 2, SingleLineComment = 3, RegularExpressionLiteral = 4, OpenBracket = 5,
        CloseBracket = 6, OpenParen = 7, CloseParen = 8, OpenBrace = 9, TemplateCloseBrace = 10, CloseBrace = 11, SemiColon = 12, Comma =
            13, Assign = 14, QuestionMark = 15, QuestionMarkDot = 16, Colon = 17, Ellipsis = 18, Dot = 19, PlusPlus = 20, MinusMinus = 21,
        Plus = 22, Minus = 23, BitNot = 24, Not = 25, Multiply = 26, Divide = 27, Modulus = 28, Power = 29, NullCoalesce = 30, Hashtag = 31,
        RightShiftArithmetic = 32, LeftShiftArithmetic = 33, RightShiftLogical = 34, LessThan = 35, MoreThan = 36, LessThanEquals = 37,
        GreaterThanEquals = 38, Equals_ = 39, NotEquals = 40, IdentityEquals = 41, IdentityNotEquals = 42, And = 43, Or = 44, BitAnd = 45,
        BitXOr = 46, BitOr = 47, MultiplyAssign = 48, DivideAssign = 49, ModulusAssign = 50, PlusAssign = 51, MinusAssign = 52,
        LeftShiftArithmeticAssign = 53, RightShiftArithmeticAssign = 54, RightShiftLogicalAssign = 55, BitAndAssign = 56, BitXorAssign = 57,
        BitOrAssign = 58, PowerAssign = 59, NullishCoalescingAssign = 60, ARROW = 61, NullLiteral = 62, BooleanLiteral = 63,
        DecimalLiteral = 64, HexIntegerLiteral = 65, OctalIntegerLiteral = 66, OctalIntegerLiteral2 = 67, BinaryIntegerLiteral = 68,
        BigHexIntegerLiteral = 69, BigOctalIntegerLiteral = 70, BigBinaryIntegerLiteral = 71, BigDecimalIntegerLiteral = 72, Break = 73,
        Do = 74, Instanceof = 75, Typeof = 76, Case = 77, Else = 78, New = 79, Var = 80, Catch = 81, Finally = 82, Return = 83, Void = 84,
        Continue = 85, For = 86, Switch = 87, While = 88, Debugger = 89, Function_ = 90, This = 91, With = 92, Default = 93, If = 94,
        Throw = 95, Delete = 96, In = 97, Try = 98, As = 99, From = 100, Of = 101, Yield = 102, YieldStar = 103, Class = 104, Enum = 105,
        Extends = 106, Super = 107, Const = 108, Export = 109, Import = 110, Async = 111, Await = 112, Implements = 113, StrictLet = 114,
        NonStrictLet = 115, Private = 116, Public = 117, Interface = 118, Package = 119, Protected = 120, Static = 121, Identifier = 122,
        StringLiteral = 123, BackTick = 124, WhiteSpaces = 125, LineTerminator = 126, HtmlComment = 127, CDataComment = 128,
        UnexpectedCharacter = 129, TemplateStringStartExpression = 130, TemplateStringAtom = 131;
    public static final int RULE_program = 0, RULE_sourceElement = 1, RULE_statement = 2, RULE_block = 3, RULE_statementList = 4,
        RULE_importStatement = 5, RULE_importFromBlock = 6, RULE_importModuleItems = 7, RULE_importAliasName = 8, RULE_moduleExportName = 9,
        RULE_importedBinding = 10, RULE_importDefault = 11, RULE_importNamespace = 12, RULE_importFrom = 13, RULE_aliasName = 14,
        RULE_exportStatement = 15, RULE_exportFromBlock = 16, RULE_exportModuleItems = 17, RULE_exportAliasName = 18, RULE_declaration = 19,
        RULE_variableStatement = 20, RULE_variableDeclarationList = 21, RULE_singleVariableDeclaration = 22, RULE_variableDeclaration = 23,
        RULE_emptyStatement_ = 24, RULE_expressionStatement = 25, RULE_ifStatement = 26, RULE_iterationStatement = 27, RULE_varModifier =
            28, RULE_continueStatement = 29, RULE_breakStatement = 30, RULE_returnStatement = 31, RULE_yieldStatement = 32,
        RULE_withStatement = 33, RULE_switchStatement = 34, RULE_caseBlock = 35, RULE_caseClauses = 36, RULE_caseClause = 37,
        RULE_defaultClause = 38, RULE_labelledStatement = 39, RULE_throwStatement = 40, RULE_tryStatement = 41, RULE_catchProduction = 42,
        RULE_finallyProduction = 43, RULE_debuggerStatement = 44, RULE_functionDeclaration = 45, RULE_classDeclaration = 46,
        RULE_classTail = 47, RULE_classElement = 48, RULE_methodDefinition = 49, RULE_fieldDefinition = 50, RULE_classElementName = 51,
        RULE_privateIdentifier = 52, RULE_formalParameterList = 53, RULE_formalParameterArg = 54, RULE_lastFormalParameterArg = 55,
        RULE_functionBody = 56, RULE_sourceElements = 57, RULE_arrayLiteral = 58, RULE_elementList = 59, RULE_arrayElement = 60,
        RULE_propertyAssignment = 61, RULE_propertyName = 62, RULE_arguments = 63, RULE_argument = 64, RULE_expressionSequence = 65,
        RULE_singleExpression = 66, RULE_initializer = 67, RULE_assignable = 68, RULE_objectLiteral = 69, RULE_anonymousFunction = 70,
        RULE_arrowFunctionParameters = 71, RULE_arrowFunctionBody = 72, RULE_assignmentOperator = 73, RULE_literal = 74,
        RULE_templateStringLiteral = 75, RULE_templateStringAtom = 76, RULE_numericLiteral = 77, RULE_bigintLiteral = 78, RULE_getter = 79,
        RULE_setter = 80, RULE_identifierName = 81, RULE_identifier = 82, RULE_reservedWord = 83, RULE_keyword = 84, RULE_let_ = 85,
        RULE_eos = 86;
    ...
    public static class SourceElementContext extends ParserRuleContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitSourceElement(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class StatementListContext extends ParserRuleContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitStatementList(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class ImportStatementContext extends ParserRuleContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitImportStatement(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class ImportFromBlockContext extends ParserRuleContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitImportFromBlock(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class ImportModuleItemsContext extends ParserRuleContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitImportModuleItems(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class ImportAliasNameContext extends ParserRuleContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitImportAliasName(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class ModuleExportNameContext extends ParserRuleContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitModuleExportName(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class ImportedBindingContext extends ParserRuleContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitImportedBinding(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class ImportDefaultContext extends ParserRuleContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitImportDefault(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class ImportNamespaceContext extends ParserRuleContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitImportNamespace(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class ExportDefaultDeclarationContext extends ExportStatementContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor)
    ...
    public static class ExportDeclarationContext extends ExportStatementContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitExportDeclaration(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class ExportFromBlockContext extends ParserRuleContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitExportFromBlock(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class ExportModuleItemsContext extends ParserRuleContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitExportModuleItems(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class ExportAliasNameContext extends ParserRuleContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitExportAliasName(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class VariableStatementContext extends ParserRuleContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitVariableStatement(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class SingleVariableDeclarationContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_singleVariableDeclaration;
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor)
                .visitSingleVariableDeclaration(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class EmptyStatement_Context extends ParserRuleContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitEmptyStatement_(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public final ExpressionStatementContext expressionStatement() throws RecognitionException {
        ...
        try {
            ...
            {
                setState(359);
                if (!(this.notOpenBraceAndNotFunction() && !this.isVariableDeclarationStart())) throw new FailedPredicateException(
                    this,
                    "this.notOpenBraceAndNotFunction() && !this.isVariableDeclarationStart()"
                );
                setState(360);
                expressionSequence();
                setState(361);
    ...
    public static class WhileStatementContext extends IterationStatementContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitWhileStatement(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class ForInStatementContext extends IterationStatementContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitForInStatement(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class ForOfStatementContext extends IterationStatementContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitForOfStatement(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class ContinueStatementContext extends ParserRuleContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitContinueStatement(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class BreakStatementContext extends ParserRuleContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitBreakStatement(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class ReturnStatementContext extends ParserRuleContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitReturnStatement(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class YieldStatementContext extends ParserRuleContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitYieldStatement(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class WithStatementContext extends ParserRuleContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitWithStatement(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class SwitchStatementContext extends ParserRuleContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitSwitchStatement(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class DefaultClauseContext extends ParserRuleContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitDefaultClause(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class LabelledStatementContext extends ParserRuleContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitLabelledStatement(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class ThrowStatementContext extends ParserRuleContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitThrowStatement(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class CatchProductionContext extends ParserRuleContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitCatchProduction(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class FinallyProductionContext extends ParserRuleContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitFinallyProduction(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class DebuggerStatementContext extends ParserRuleContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitDebuggerStatement(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class ClassDeclarationContext extends ParserRuleContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitClassDeclaration(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class MethodDefinitionContext extends ParserRuleContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitMethodDefinition(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class FieldDefinitionContext extends ParserRuleContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitFieldDefinition(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class ClassElementNameContext extends ParserRuleContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitClassElementName(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class PrivateIdentifierContext extends ParserRuleContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitPrivateIdentifier(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class FormalParameterArgContext extends ParserRuleContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitFormalParameterArg(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class SourceElementsContext extends ParserRuleContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitSourceElements(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class PropertyShorthandContext extends PropertyAssignmentContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitPropertyShorthand(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class PropertySetterContext extends PropertyAssignmentContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitPropertySetter(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class PropertyGetterContext extends PropertyAssignmentContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitPropertyGetter(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class FunctionPropertyContext extends PropertyAssignmentContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitFunctionProperty(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class ExpressionSequenceContext extends ParserRuleContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitExpressionSequence(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class TernaryExpressionContext extends SingleExpressionContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitTernaryExpression(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class PowerExpressionContext extends SingleExpressionContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitPowerExpression(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class MetaExpressionContext extends SingleExpressionContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitMetaExpression(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class OptionalChainExpressionContext extends SingleExpressionContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor)
                .visitOptionalChainExpression(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class NotExpressionContext extends SingleExpressionContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitNotExpression(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class AwaitExpressionContext extends SingleExpressionContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitAwaitExpression(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class ThisExpressionContext extends SingleExpressionContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitThisExpression(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class FunctionExpressionContext extends SingleExpressionContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitFunctionExpression(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class TypeofExpressionContext extends SingleExpressionContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitTypeofExpression(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class DeleteExpressionContext extends SingleExpressionContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitDeleteExpression(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class ImportExpressionContext extends SingleExpressionContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitImportExpression(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class EqualityExpressionContext extends SingleExpressionContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitEqualityExpression(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class BitXOrExpressionContext extends SingleExpressionContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitBitXOrExpression(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class SuperExpressionContext extends SingleExpressionContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitSuperExpression(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class BitShiftExpressionContext extends SingleExpressionContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitBitShiftExpression(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class AdditiveExpressionContext extends SingleExpressionContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitAdditiveExpression(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class YieldExpressionContext extends SingleExpressionContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitYieldExpression(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class BitNotExpressionContext extends SingleExpressionContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitBitNotExpression(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class NewExpressionContext extends SingleExpressionContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitNewExpression(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class LiteralExpressionContext extends SingleExpressionContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitLiteralExpression(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class ClassExpressionContext extends SingleExpressionContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitClassExpression(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class BitAndExpressionContext extends SingleExpressionContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitBitAndExpression(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class BitOrExpressionContext extends SingleExpressionContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitBitOrExpression(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class VoidExpressionContext extends SingleExpressionContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitVoidExpression(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class CoalesceExpressionContext extends SingleExpressionContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitCoalesceExpression(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class ObjectLiteralContext extends ParserRuleContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitObjectLiteral(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class AnonymousFunctionDeclContext extends AnonymousFunctionContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor)
                .visitAnonymousFunctionDecl(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ArrowFunctionContext extends AnonymousFunctionContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitArrowFunction(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class NamedFunctionContext extends AnonymousFunctionContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitNamedFunction(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class ArrowFunctionBodyContext extends ParserRuleContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitArrowFunctionBody(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class AssignmentOperatorContext extends ParserRuleContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitAssignmentOperator(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class TemplateStringLiteralContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor)
                .visitTemplateStringLiteral(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class TemplateStringAtomContext extends ParserRuleContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitTemplateStringAtom(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class NumericLiteralContext extends ParserRuleContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitNumericLiteral(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class BigintLiteralContext extends ParserRuleContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitBigintLiteral(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static class IdentifierNameContext extends ParserRuleContext {
        ...
        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JavascriptParserVisitor) return ((JavascriptParserVisitor<? extends T>) visitor).visitIdentifierName(
                this
            );
            else return visitor.visitChildren(this);
        }
    ...
    public static final String _serializedATN = "\u0004\u0001\u0083\u044f\u0002\u0000\u0007\u0000\u0002\u0001\u0007\u0001"
        + "\u0002\u0002\u0007\u0002\u0002\u0003\u0007\u0003\u0002\u0004\u0007\u0004"
        + "\u0002\u0005\u0007\u0005\u0002\u0006\u0007\u0006\u0002\u0007\u0007\u0007"
        + "\u0002\b\u0007\b\u0002\t\u0007\t\u0002\n\u0007\n\u0002\u000b\u0007\u000b"
        + "\u0002\f\u0007\f\u0002\r\u0007\r\u0002\u000e\u0007\u000e\u0002\u000f\u0007"
