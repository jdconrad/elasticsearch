...
import org.elasticsearch.javascript.symbol.Decorations.Converter;
...
public class JavascriptUserTreeToIRTreePhase extends DefaultUserTreeToIRTreePhase {
    ...
    // adds static fields and getter methods required by JavascriptScript for exception handling
     ...
     *
     * } catch (JavascriptExplainError e) {
     ...
     * and
     *
     * } catch (JavascriptError | LinkageError | OutOfMemoryError | StackOverflowError | Exception e) {
    ...
    protected static void injectSandboxExceptions(FunctionNode irFunctionNode) {
        try {
            ...
            ThrowNode irThrowNode = createCatchAndThrow(JavascriptExplainError.class, internalLocation, irTryNode);
            ...
            irLoadVariableNode.attachDecoration(new IRDName("#javascriptExplainError"));
            ...
            irLoadVariableNode.attachDecoration(new IRDExpressionType(JavascriptExplainError.class));
            irLoadVariableNode.attachDecoration(new IRDName("#javascriptExplainError"));
            ...
            irInvokeCallNode.setBox(JavascriptExplainError.class);
            irInvokeCallNode.setMethod(
                new JavascriptMethod(
                    JavascriptExplainError.class.getMethod("getHeaders", JavascriptLookup.class),
                    JavascriptExplainError.class,
                    null,
                    List.of(),
                    null,
                    null,
            ...
            for (Class<? extends Throwable> throwable : List.of(
                ...
                JavascriptWrappedException.class,
                LinkageError.class,
                ...
                irInvokeCallNode.setMethod(
                    new JavascriptMethod(Collections.class.getMethod("emptyMap"), Collections.class, null, List.of(), null, null, Map.of())
                );
    ...
    public void visitCallLocal(ECallLocal userCallLocalNode, ScriptScope scriptScope) {
        if ("$".equals(userCallLocalNode.getMethodName())) {
            JavascriptMethod thisMethod = scriptScope.getDecoration(userCallLocalNode, ThisJavascriptMethod.class).thisJavascriptMethod();
