...
import static org.elasticsearch.javascript.WriterConstants.CLASS_VERSION;
import static org.elasticsearch.javascript.WriterConstants.CTOR_METHOD_NAME;
import static org.elasticsearch.javascript.WriterConstants.DELEGATE_BOOTSTRAP_HANDLE;
 ...
 * lambda functions and method references within Javascript.  The code generation
 * used here is based upon the following article:
 * http://cr.openjdk.java.net/~briangoetz/lambda/lambda-translation.html
 * However, it is a simplified version as Javascript has no concept of generics
 * or serialization.  LambdaBootstrap is being used as a replacement for
 * {@link java.lang.invoke.LambdaMetafactory} since the Javascript casting model
 * cannot be fully supported through this class.
 *
 * <p>For each lambda function/method reference used within a Javascript script
 ...
 * </ol>
 *
 * <p>Take for example the following Javascript script:
 *
 * <pre>{@code
 ...
 *             Javascript$Script.lambda$0(this.arg$0, val$0);
 *         }
 *     }
 *
 *     public class Javascript$Script implements ... {
 *         ...
...
public final class LambdaBootstrap {
     ...
     * within a Javascript script.  Variables with the prefix interface are considered
     ...
     * within the Javascript script.  The interface method delegates (calls) to the
     * delegate method.
     ...
     * @param delegateMethodName The name of the method to be called in the Javascript script class
     * @param delegateMethodType The type of method call in the Javascript script class without
     *                           the captured types
     ...
     * that originally defined the class for the Javascript script.
     */
