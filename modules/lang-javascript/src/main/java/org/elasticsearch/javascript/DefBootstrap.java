...
/**
 * Javascript invokedynamic bootstrap for the call site.
 * <p>
 ...
 */
// NOTE: this class must be public, because generated javascript classes are in a different classloader,
...
public final class DefBootstrap {
            ...
            final ClassValue<MethodHandle> megamorphicCache = new ClassValue<MethodHandle>() {
                ...
                protected MethodHandle computeValue(Class<?> receiverType) {
                    ...
                    try {
                        ...
                        // use a sentinel class [JavascriptWrappedException] here to work around
                        // this issue and later unwrap the original exception
                        Def.rethrow(t instanceof Exception ? new JavascriptWrappedException((Exception) t) : t);
     ...
     * </ul>
     * And we take the {@link JavascriptLookup} used to compile the script for whitelist checking.
     * <p>
    ...
    public static CallSite bootstrap(
        ...
        switch (flavor) {
            ...
            case METHOD_CALL -> {
                ...
                return new PIC(javascriptLookup, functions, constants, methodHandlesLookup, name, type, initialDepth, flavor, args);
            }
