...
import org.elasticsearch.javascript.phase.DefaultConstantFoldingOptimizationPhase;
import org.elasticsearch.javascript.phase.DefaultEqualityMethodOptimizationPhase;
import org.elasticsearch.javascript.phase.DefaultIRTreeToASMBytesPhase;
import org.elasticsearch.javascript.phase.DefaultStaticConstantExtractionPhase;
import org.elasticsearch.javascript.phase.DefaultStringConcatenationOptimizationPhase;
import org.elasticsearch.javascript.phase.IRTreeVisitor;
import org.elasticsearch.javascript.phase.JavascriptSemanticAnalysisPhase;
import org.elasticsearch.javascript.phase.JavascriptSemanticHeaderPhase;
import org.elasticsearch.javascript.phase.JavascriptUserTreeToIRTreePhase;
...
/**
 * The Compiler is the entry point for generating a Javascript script.  The compiler will receive a Javascript
...
final class Compiler {
    ...
    /**
     * A secure class loader used to define Javascript scripts.
     */
    final class Loader extends SecureClassLoader {
         ...
         * the {@link JavascriptLookup} was initially created.  Allows for {@link Whitelist}ed
        ...
        public Class<?> findClass(String name) throws ClassNotFoundException {
            ...
            found = javascriptLookup.javaClassNameToClass(name);
         ...
         * @param name The name of the class.
         * @param bytes The generated byte code.
         * @return A Class object extending {@link JavascriptScript}.
         */
        Class<? extends JavascriptScript> defineScript(String name, byte[] bytes) {
            return defineClass(name, bytes, 0, bytes.length, CODESOURCE).asSubclass(JavascriptScript.class);
        }
     ...
     * {@link Compiler}'s specified {@link JavascriptLookup}.
     */
     ...
     * @param javascriptLookup The whitelist the script will use.
     */
    Compiler(Class<?> scriptClass, Class<?> factoryClass, Class<?> statefulFactoryClass, JavascriptLookup javascriptLookup) {
    ...
    /**
     * Runs the two-pass compiler to generate a Javascript script.
    ...
    ScriptScope compile(Loader loader, String name, String source, CompilerSettings settings) {
        ...
        try {
            Class<? extends JavascriptScript> clazz = loader.defineScript(CLASS_NAME, bytes);
    ...
    /**
     * Runs the two-pass compiler to generate a Javascript script.  (Used by the debugger.)
     * @param source The source code for the script.
     * @param settings The CompilerSettings to be used during the compilation.
    ...
    /**
     * Runs the two-pass compiler to generate a Javascript script with option visitors for each major phase.
     */
    byte[] compile(
        String name,
        String source,
