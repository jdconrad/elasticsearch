...
public class JavascriptCast {

    /** Create a standard cast with no boxing/unboxing. */
    public static JavascriptCast originalTypetoTargetType(Class<?> originalType, Class<?> targetType, boolean explicitCast) {
        Objects.requireNonNull(originalType);
        Objects.requireNonNull(targetType);

        return new JavascriptCast(originalType, targetType, explicitCast, null, null, null, null);
    }

    /** Create a cast where the original type will be unboxed, and then the cast will be performed. */
    public static JavascriptCast unboxOriginalType(
        Class<?> originalType,
        Class<?> targetType,
        ...
        return new JavascriptCast(originalType, targetType, explicitCast, unboxOriginalType, null, null, null);
    }
    ...
    public static JavascriptCast unboxTargetType(
        ...
        return new JavascriptCast(originalType, targetType, explicitCast, null, unboxTargetType, null, null);
    }
    ...
    public static JavascriptCast boxOriginalType(
        ...
        return new JavascriptCast(originalType, targetType, explicitCast, null, null, boxOriginalType, null);
    }

    /** Create a cast where the target type will be boxed, and then the cast will be performed. */
    public static JavascriptCast boxTargetType(Class<?> originalType, Class<?> targetType, boolean explicitCast, Class<?> boxTargetType) {

        Objects.requireNonNull(originalType);
        Objects.requireNonNull(targetType);
        Objects.requireNonNull(boxTargetType);

        return new JavascriptCast(originalType, targetType, explicitCast, null, null, null, boxTargetType);
    }
    ...
    public static JavascriptCast unboxOriginalTypeToBoxTargetType(
        ...
        return new JavascriptCast(null, null, explicitCast, unboxOriginalType, null, null, boxTargetType);
    }
    ...
    public boolean equals(Object object) {
        ...
        JavascriptCast that = (JavascriptCast) object;
