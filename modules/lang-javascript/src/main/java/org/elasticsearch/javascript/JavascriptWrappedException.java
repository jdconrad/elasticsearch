 ...
 * which leads to unexpected behavior in Javascript. This class is used as a
 * workaround for that exception wrapping.
 */
public class JavascriptWrappedException extends Error {

    /**
     * Constructor.
     * @param cause The {@link Exception} cause.
     */
    public JavascriptWrappedException(final Exception cause) {
        super(cause);
    }
}
