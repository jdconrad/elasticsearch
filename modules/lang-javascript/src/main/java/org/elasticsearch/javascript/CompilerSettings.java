...
public final class CompilerSettings {
     ...
     * {@code script.javascript.regex.limit-factor} setting.
     */
    public static final Setting<RegexEnabled> REGEX_ENABLED = new Setting<>(
        "script.javascript.regex.enabled",
    ...
    public static final Setting<Integer> REGEX_LIMIT_FACTOR = Setting.intSetting(
        "script.javascript.regex.limit-factor",
        6,
        1,
        Property.NodeScope
    );
    ...
    /**
     * Options for {@code script.javascript.regex.enabled} setting.
     */
