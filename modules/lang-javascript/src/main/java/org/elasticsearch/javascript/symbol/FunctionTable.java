...
public class FunctionTable {
    ...
    public static class LocalFunction {
        ...
        private LocalFunction(
            ...
            Class<?> javaReturnType = JavascriptLookupUtility.typeToJavaType(returnType);
            Class<?>[] javaTypeParameters = typeParameters.stream().map(JavascriptLookupUtility::typeToJavaType).toArray(Class<?>[]::new);
