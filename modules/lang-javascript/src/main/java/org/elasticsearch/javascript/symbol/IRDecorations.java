...
import org.elasticsearch.javascript.ir.IRNode.IRCondition;
import org.elasticsearch.javascript.ir.IRNode.IRDecoration;
...
public class IRDecorations {
    ...
    public abstract static class IRDType extends IRDecoration<Class<?>> {
        ...
        public String toString() {
            return JavascriptLookupUtility.typeToCanonicalTypeName(getValue());
        }
    }
    ...
    public static class IRDCast extends IRDecoration<JavascriptCast> {

        public IRDCast(JavascriptCast value) {
            super(value);
        }
    }
    ...
    public static class IRDMethod extends IRDecoration<JavascriptMethod> {

        public IRDMethod(JavascriptMethod value) {
            super(value);
        }

        @Override
        public String toString() {
            return JavascriptLookupUtility.buildJavascriptMethodKey(getValue().javaMethod().getName(), getValue().typeParameters().size());
        }
    }
    ...
    public static class IRDThisMethod extends IRDecoration<JavascriptMethod> {

        public IRDThisMethod(JavascriptMethod value) {
            super(value);
        }
    ...
    public static class IRDClassBinding extends IRDecoration<JavascriptClassBinding> {

        public IRDClassBinding(JavascriptClassBinding value) {
            super(value);
        }
    }

    /** describes the call to an instance binding */
    public static class IRDInstanceBinding extends IRDecoration<JavascriptInstanceBinding> {

        public IRDInstanceBinding(JavascriptInstanceBinding value) {
            super(value);
        }
    }

    /** describes a constructor for a new instruction */
    public static class IRDConstructor extends IRDecoration<JavascriptConstructor> {

        public IRDConstructor(JavascriptConstructor value) {
            super(value);
        }
    }
    ...
    public static class IRDField extends IRDecoration<JavascriptField> {

        public IRDField(JavascriptField value) {
            super(value);
        }
    }
