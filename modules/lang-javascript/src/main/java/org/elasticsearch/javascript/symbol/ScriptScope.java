...
public class ScriptScope extends Decorator {
    ...
    protected final JavascriptLookup javascriptLookup;
    ...
    public ScriptScope(
        ...
        staticConstants.put("$DEFINITION", javascriptLookup);
        staticConstants.put("$FUNCTIONS", functionTable);
        staticConstants.put("$COMPILERSETTINGS", compilerSettings.asMap());
    }

    public JavascriptLookup getJavascriptLookup() {
        return javascriptLookup;
    }
