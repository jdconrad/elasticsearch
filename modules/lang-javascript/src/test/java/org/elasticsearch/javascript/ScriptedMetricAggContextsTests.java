...
public class ScriptedMetricAggContextsTests extends ScriptTestCase {
    ...
    protected Map<ScriptContext<?>, List<Whitelist>> scriptContexts() {
        ...
        contexts.put(ScriptedMetricAggContexts.InitScript.CONTEXT, JAVASCRIPT_BASE_WHITELIST);
        contexts.put(ScriptedMetricAggContexts.MapScript.CONTEXT, JAVASCRIPT_BASE_WHITELIST);
        contexts.put(ScriptedMetricAggContexts.CombineScript.CONTEXT, JAVASCRIPT_BASE_WHITELIST);
        contexts.put(ScriptedMetricAggContexts.ReduceScript.CONTEXT, JAVASCRIPT_BASE_WHITELIST);
        return contexts;
    }
