...
import org.elasticsearch.javascript.JavascriptPlugin;
import org.elasticsearch.javascript.action.JavascriptExecuteAction.Request;
import org.elasticsearch.javascript.action.JavascriptExecuteAction.Response;
...
import static org.elasticsearch.javascript.action.JavascriptExecuteAction.TransportAction.innerShardOperation;
import static org.hamcrest.Matchers.equalTo;
import static org.hamcrest.Matchers.nullValue;

public class JavascriptExecuteApiTests extends ESSingleNodeTestCase {

    @Override
    protected Collection<Class<? extends Plugin>> getPlugins() {
        return Collections.singleton(JavascriptPlugin.class);
    }

    public void testDefaults() throws IOException {
        ScriptService scriptService = getInstanceFromNode(ScriptService.class);
        Request request = new Request(new Script(ScriptType.INLINE, "javascript", "100.0 / 1000.0", emptyMap()), null, null);
        ...
        request = new Request(new Script(ScriptType.INLINE, "javascript", "params.count / params.total", params), null, null);
        response = innerShardOperation(request, scriptService, null);
        assertThat(response.getResult(), equalTo("0.1"));

        Exception e = expectThrows(ScriptException.class, () -> {
            Request r = new Request(
                new Script(ScriptType.INLINE, "javascript", "params.count / params.total + doc['constant']", params),
                null,
                null
            );
    ...
    public void testNestedDocs() throws IOException {
        ...
        Request request = new Request(new Script(ScriptType.INLINE, "javascript", "doc['rank'].value", Map.of()), "score", contextSetup);
    ...
    public void testFilterExecutionContext() throws IOException {
        ...
        Request request = new Request(
            new Script(ScriptType.INLINE, "javascript", "doc['field'].value >= 3", emptyMap()),
            "filter",
            contextSetup
        );
        Response response = innerShardOperation(request, scriptService, indexService);
        ...
        contextSetup.setXContentType(XContentType.JSON);
        request = new Request(
            new Script(ScriptType.INLINE, "javascript", "doc['field'].value >= params.max", singletonMap("max", 3)),
            "filter",
            contextSetup
        );
    ...
    public void testBooleanFieldExecutionContext() throws IOException {
        ...
        contextSetup.setXContentType(XContentType.JSON);
        Request request = new Request(
            new Script(ScriptType.INLINE, "javascript", "emit(doc['rank'].value < params.max_rank)", singletonMap("max_rank", 5.0)),
            "boolean_field",
            contextSetup
        );
        Response response = innerShardOperation(request, scriptService, indexService);
        ...
        contextSetup.setXContentType(XContentType.JSON);
        request = new Request(
            new Script(ScriptType.INLINE, "javascript", "emit(false); emit(true); emit (false);", emptyMap()),
            "boolean_field",
            contextSetup
        );
        response = innerShardOperation(request, scriptService, indexService);
    ...
    public void testDateFieldExecutionContext() throws IOException {
        ...
        contextSetup.setXContentType(XContentType.JSON);
        Request request = new Request(
            new Script(ScriptType.INLINE, "javascript", "emit(doc['test_date'].value.toInstant().toEpochMilli())", emptyMap()),
            "date_field",
            contextSetup
        );
        Response response = innerShardOperation(request, scriptService, indexService);
        ...
        contextSetup = new Request.ContextSetup("index", new BytesArray("{}"), new MatchAllQueryBuilder());
        contextSetup.setXContentType(XContentType.JSON);
        request = new Request(new Script(ScriptType.INLINE, "javascript", """
    ...
    public void testDoubleFieldExecutionContext() throws IOException {
        ...
        contextSetup.setXContentType(XContentType.JSON);
        Request request = new Request(
            new Script(ScriptType.INLINE, "javascript", "emit(doc['rank'].value); emit(Math.log(doc['rank'].value))", emptyMap()),
            "double_field",
            contextSetup
        );
        Response response = innerShardOperation(request, scriptService, indexService);
    ...
    public void testGeoPointFieldExecutionContext() throws IOException {
        ...
        contextSetup.setXContentType(XContentType.JSON);
        Request request = new Request(
            new Script(ScriptType.INLINE, "javascript", "emit(doc['test_point'].value.lat, doc['test_point'].value.lon)", emptyMap()),
            "geo_point_field",
            contextSetup
        );
        Response response = innerShardOperation(request, scriptService, indexService);
        ...
        contextSetup.setXContentType(XContentType.JSON);
        request = new Request(
            new Script(ScriptType.INLINE, "javascript", "emit(78.96, 12.12); emit(13.45, 56.78);", emptyMap()),
            "geo_point_field",
            contextSetup
        );
        response = innerShardOperation(request, scriptService, indexService);
    ...
    public void testIpFieldExecutionContext() throws IOException {
        ...
        contextSetup.setXContentType(XContentType.JSON);
        Request request = new Request(
            new Script(ScriptType.INLINE, "javascript", "emit(doc['test_ip'].value);", emptyMap()),
            "ip_field",
            contextSetup
        );
        Response response = innerShardOperation(request, scriptService, indexService);
    ...
    public void testLongFieldExecutionContext() throws IOException {
        ...
        contextSetup.setXContentType(XContentType.JSON);
        Request request = new Request(
            new Script(ScriptType.INLINE, "javascript", "emit(doc['test_value'].value); emit(doc['test_value'].value - 2);", emptyMap()),
            "long_field",
            contextSetup
        );
        Response response = innerShardOperation(request, scriptService, indexService);
    ...
    public void testKeywordFieldExecutionContext() throws IOException {
        ...
        contextSetup.setXContentType(XContentType.JSON);
        Request request = new Request(
            new Script(ScriptType.INLINE, "javascript", "emit(doc['rank'].value + doc['text'].value)", emptyMap()),
            "keyword_field",
            contextSetup
        );
        Response response = innerShardOperation(request, scriptService, indexService);
    ...
    public void testCompositeExecutionContext() throws IOException {
        ...
        contextSetup.setXContentType(XContentType.JSON);
        Request request = new Request(
            new Script(ScriptType.INLINE, "javascript", "emit(\"foo\", \"bar\"); emit(\"foo2\", 2);", emptyMap()),
            "composite_field",
            contextSetup
        );
        Response response = innerShardOperation(request, scriptService, indexService);
    ...
    public void testContextWhitelists() throws IOException {
        ScriptService scriptService = getInstanceFromNode(ScriptService.class);
        // score
        Request request = new Request(new Script(ScriptType.INLINE, "javascript", "sigmoid(1.0, 2.0, 3.0)", emptyMap()), null, null);
        Response response = innerShardOperation(request, scriptService, null);
        double result = Double.parseDouble((String) response.getResult());
        assertEquals(0.111, result, 0.001);

        // ingest
        request = new Request(new Script(ScriptType.INLINE, "javascript", "'foo'.sha1()", emptyMap()), null, null);
        response = innerShardOperation(request, scriptService, null);
        assertEquals("0beec7b5ea3f0fdbc95d0dd47f3c5bc275da8a33", response.getResult());

        // json
        request = new Request(
            new Script(ScriptType.INLINE, "javascript", "Json.load('{\"a\": 1, \"b\": 2}')['b']", emptyMap()),
            null,
            null
        );
        response = innerShardOperation(request, scriptService, null);
    ...
    public void testRemoveClusterAliasFromIndexExpression() {
        {
            ...
            JavascriptExecuteAction.Request request = createRequest("blogs");
            assertThat(request.index(), equalTo("blogs"));
            JavascriptExecuteAction.TransportAction.removeClusterAliasFromIndexExpression(request);
            assertThat(request.index(), equalTo("blogs"));
        }
        {
            // index expressions with no index specified should come back unchanged
            JavascriptExecuteAction.Request request = createRequest(null);
        ...
        }
        {
            ...
            JavascriptExecuteAction.Request request = createRequest("remote1:blogs");
        ...
        {
            // index expressions with clusterAlias should come back with it stripped off
            JavascriptExecuteAction.Request request = createRequest("remote1:remote1");
    ...
    public void testMarkOriginOnly() {
        JavascriptExecuteAction.Request request = createRequest("p1:blogs");
    ...
    private JavascriptExecuteAction.Request createRequest(String indexExpression) {
        return new JavascriptExecuteAction.Request(
            new Script(ScriptType.INLINE, "javascript", "100.0 / 1000.0", emptyMap()),
            null,
