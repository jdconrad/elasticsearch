...
public class AugmentationTests extends ScriptTestCase {
    ...
    public void testFeatureTest() {
        ...
        assertEquals(
            5,
            exec("def ft = new org.elasticsearch.javascript.FeatureTestObject();" + " ft.setX(3); ft.setY(2); return ft.getTotal()")
        );
        assertEquals(
            8,
            exec(
        ...
        assertEquals(
            8,
            exec("def ft = new org.elasticsearch.javascript.FeatureTestObject();" + " ft.setX(3); ft.setY(2); return ft.addToTotal(3)")
        );
    }
