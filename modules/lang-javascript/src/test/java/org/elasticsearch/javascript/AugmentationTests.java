...
public class AugmentationTests extends ScriptTestCase {
    ...
    public void testIterable_Each() {
        assertEquals(1, exec("let l = new ArrayList(); l.add(1); let l2 = new ArrayList(); l.each(l2::add); return l2.size()"));
    }

    public void testIterable_EachWithIndex() {
        assertEquals(0, exec("let l = new ArrayList(); l.add(2); let m = new HashMap(); l.eachWithIndex(m::put); return m.get(2)"));
    }
    ...
    public void testMap_Each() {
        assertEquals(2, exec("let m = new TreeMap(); m.one = 1; m.two = 2; let m2 = new TreeMap(); m.each(m2::put); return m2.size()"));
    }
