...
public class FunctionRefTests extends ScriptTestCase {
    ...
    public void testQualifiedStaticMethodReference() {
        assertEquals(
            true,
            exec("List l = [true]; l.stream().map(org.elasticsearch.javascript.FeatureTestObject::overloadedStatic).findFirst().get()")
        );
    }
    ...
    public void testQualifiedStaticMethodReferenceDef() {
        assertEquals(
            true,
            exec("def l = [true]; l.stream().map(org.elasticsearch.javascript.FeatureTestObject::overloadedStatic).findFirst().get()")
        );
    }
    ...
    public void testCapturingMethodReferenceMultipleLambdas() {
        assertEquals(
            ...
            exec(
                "String x = 'testing';"
                    + "String y = 'abcdefg';"
                    + "org.elasticsearch.javascript.FeatureTestObject test = new org.elasticsearch.javascript.FeatureTestObject(2,3);"
    ...
    public void testCapturingMethodReferenceMultipleLambdasDefInterface() {
        assertEquals(
            ...
            exec(
                "String x = 'testing';"
                    + "String y = 'abcdefg';"
                    + "def test = new org.elasticsearch.javascript.FeatureTestObject(2,3);"
                    + "return test.twoFunctionsOfX(x::concat, y::substring);"
            )
        );
    }
