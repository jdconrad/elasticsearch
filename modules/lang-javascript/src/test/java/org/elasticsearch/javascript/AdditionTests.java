...
public class AdditionTests extends ScriptTestCase {
    ...
    public void testInt() throws Exception {
        assertEquals(1 + 1, exec("let x = 1; let y = 1; return x+y;"));
        assertEquals(1 + 2, exec("let x = 1; let y = 2; return x+y;"));
        assertEquals(5 + 10, exec("let x = 5; let y = 10; return x+y;"));
        assertEquals(1 + 1 + 2, exec("let x = 1; let y = 1; let z = 2; return x+y+z;"));
        assertEquals((1 + 1) + 2, exec("let x = 1; let y = 1; let z = 2; return (x+y)+z;"));
        assertEquals(1 + (1 + 2), exec("let x = 1; let y = 1; let z = 2; return x+(y+z);"));
        assertEquals(0 + 1, exec("let x = 0; let y = 1; return x+y;"));
        assertEquals(1 + 0, exec("let x = 1; let y = 0; return x+y;"));
        assertEquals(0 + 0, exec("let x = 0; let y = 0; return x+y;"));
        assertEquals(0 + 0, exec("let x = 0; let y = 0; return x+y;"));
    }
    ...
    public void testByte() throws Exception {
        assertEquals((byte) 1 + (byte) 1, exec("let x = 1; let y = 1; return x+y;"));
        assertEquals((byte) 1 + (byte) 2, exec("let x = 1; let y = 2; return x+y;"));
        assertEquals((byte) 5 + (byte) 10, exec("let x = 5; let y = 10; return x+y;"));
        assertEquals((byte) 1 + (byte) 1 + (byte) 2, exec("let x = 1; let y = 1; let z = 2; return x+y+z;"));
        assertEquals(((byte) 1 + (byte) 1) + (byte) 2, exec("let x = 1; let y = 1; let z = 2; return (x+y)+z;"));
        assertEquals((byte) 1 + ((byte) 1 + (byte) 2), exec("let x = 1; let y = 1; let z = 2; return x+(y+z);"));
        assertEquals((byte) 0 + (byte) 1, exec("let x = 0; let y = 1; return x+y;"));
        assertEquals((byte) 1 + (byte) 0, exec("let x = 1; let y = 0; return x+y;"));
        assertEquals((byte) 0 + (byte) 0, exec("let x = 0; let y = 0; return x+y;"));
    }

    public void testByteConst() throws Exception {
        assertEquals((byte) 1 + (byte) 1, exec("return 1+1;"));
        assertEquals((byte) 1 + (byte) 2, exec("return 1+2;"));
        assertEquals((byte) 5 + (byte) 10, exec("return 5+10;"));
        assertEquals((byte) 1 + (byte) 1 + (byte) 2, exec("return 1+1+2;"));
        assertEquals(((byte) 1 + (byte) 1) + (byte) 2, exec("return (1+1)+2;"));
        assertEquals((byte) 1 + ((byte) 1 + (byte) 2), exec("return 1+(1+2);"));
        assertEquals((byte) 0 + (byte) 1, exec("return 0+1;"));
        assertEquals((byte) 1 + (byte) 0, exec("return 1+0;"));
        assertEquals((byte) 0 + (byte) 0, exec("return 0+0;"));
    }

    public void testChar() throws Exception {
        assertEquals((char) 1 + (char) 1, exec("let x = 1; let y = 1; return x+y;"));
        assertEquals((char) 1 + (char) 2, exec("let x = 1; let y = 2; return x+y;"));
        assertEquals((char) 5 + (char) 10, exec("let x = 5; let y = 10; return x+y;"));
        assertEquals((char) 1 + (char) 1 + (char) 2, exec("let x = 1; let y = 1; let z = 2; return x+y+z;"));
        assertEquals(((char) 1 + (char) 1) + (char) 2, exec("let x = 1; let y = 1; let z = 2; return (x+y)+z;"));
        assertEquals((char) 1 + ((char) 1 + (char) 2), exec("let x = 1; let y = 1; let z = 2; return x+(y+z);"));
        assertEquals((char) 0 + (char) 1, exec("let x = 0; let y = 1; return x+y;"));
        assertEquals((char) 1 + (char) 0, exec("let x = 1; let y = 0; return x+y;"));
        assertEquals((char) 0 + (char) 0, exec("let x = 0; let y = 0; return x+y;"));
    }

    public void testCharConst() throws Exception {
        assertEquals((char) 1 + (char) 1, exec("return 1+1;"));
        assertEquals((char) 1 + (char) 2, exec("return 1+2;"));
        assertEquals((char) 5 + (char) 10, exec("return 5+10;"));
        assertEquals((char) 1 + (char) 1 + (char) 2, exec("return 1+1+2;"));
        assertEquals(((char) 1 + (char) 1) + (char) 2, exec("return (1+1)+2;"));
        assertEquals((char) 1 + ((char) 1 + (char) 2), exec("return 1+(1+2);"));
        assertEquals((char) 0 + (char) 1, exec("return 0+1;"));
        assertEquals((char) 1 + (char) 0, exec("return 1+0;"));
        assertEquals((char) 0 + (char) 0, exec("return 0+0;"));
    }

    public void testShort() throws Exception {
        assertEquals((short) 1 + (short) 1, exec("let x = 1; let y = 1; return x+y;"));
        assertEquals((short) 1 + (short) 2, exec("let x = 1; let y = 2; return x+y;"));
        assertEquals((short) 5 + (short) 10, exec("let x = 5; let y = 10; return x+y;"));
        assertEquals((short) 1 + (short) 1 + (short) 2, exec("let x = 1; let y = 1; let z = 2; return x+y+z;"));
        assertEquals(((short) 1 + (short) 1) + (short) 2, exec("let x = 1; let y = 1; let z = 2; return (x+y)+z;"));
        assertEquals((short) 1 + ((short) 1 + (short) 2), exec("let x = 1; let y = 1; let z = 2; return x+(y+z);"));
        assertEquals((short) 0 + (short) 1, exec("let x = 0; let y = 1; return x+y;"));
        assertEquals((short) 1 + (short) 0, exec("let x = 1; let y = 0; return x+y;"));
        assertEquals((short) 0 + (short) 0, exec("let x = 0; let y = 0; return x+y;"));
    }

    public void testShortConst() throws Exception {
        assertEquals((short) 1 + (short) 1, exec("return 1+1;"));
        assertEquals((short) 1 + (short) 2, exec("return 1+2;"));
        assertEquals((short) 5 + (short) 10, exec("return 5+10;"));
        assertEquals((short) 1 + (short) 1 + (short) 2, exec("return 1+1+2;"));
        assertEquals(((short) 1 + (short) 1) + (short) 2, exec("return (1+1)+2;"));
        assertEquals((short) 1 + ((short) 1 + (short) 2), exec("return 1+(1+2);"));
        assertEquals((short) 0 + (short) 1, exec("return 0+1;"));
        assertEquals((short) 1 + (short) 0, exec("return 1+0;"));
    ...
    public void testLong() throws Exception {
        ...
        assertEquals(5L + 10L, exec("let x = 5; let y = 10; return x+y;"));
        assertEquals(1L + 1L + 2L, exec("let x = 1; let y = 1; let z = 2; return x+y+z;"));
        assertEquals((1L + 1L) + 2L, exec("let x = 1; let y = 1; let z = 2; return (x+y)+z;"));
        assertEquals(1L + (1L + 2L), exec("let x = 1; let y = 1; let z = 2; return x+(y+z);"));
        assertEquals(0L + 1L, exec("let x = 0; let y = 1; return x+y;"));
        assertEquals(1L + 0L, exec("let x = 1; let y = 0; return x+y;"));
    ...
    public void testLongConst() throws Exception {
        ...
        assertEquals(5L + 10L, exec("return 5+10;"));
        assertEquals(1L + 1L + 2L, exec("return 1+1+2;"));
        assertEquals((1L + 1L) + 2L, exec("return (1+1)+2;"));
        assertEquals(1L + (1L + 2L), exec("return 1+(1+2);"));
        assertEquals(0L + 1L, exec("return 0+1;"));
        assertEquals(1L + 0L, exec("return 1+0;"));
    ...
    public void testFloat() throws Exception {
        ...
        assertEquals(5F + 10F, exec("let x = 5; let y = 10; return x+y;"));
        assertEquals(1F + 1F + 2F, exec("let x = 1; let y = 1; let z = 2; return x+y+z;"));
        assertEquals((1F + 1F) + 2F, exec("let x = 1; let y = 1; let z = 2; return (x+y)+z;"));
        assertEquals((1F + 1F) + 2F, exec("let x = 1; let y = 1; let z = 2; return x+(y+z);"));
        assertEquals(0F + 1F, exec("let x = 0; let y = 1; return x+y;"));
        assertEquals(1F + 0F, exec("let x = 1; let y = 0; return x+y;"));
    ...
    public void testFloatConst() throws Exception {
        ...
        assertEquals(5F + 10F, exec("return 5+10;"));
        assertEquals(1F + 1F + 2F, exec("return 1+1+2;"));
        assertEquals((1F + 1F) + 2F, exec("return (1+1)+2;"));
        assertEquals(1F + (1F + 2F), exec("return 1+(1+2);"));
        assertEquals(0F + 1F, exec("return 0+1;"));
        assertEquals(1F + 0F, exec("return 1+0;"));
        assertEquals(0F + 0F, exec("return 0+0;"));
    }

    public void testDouble() throws Exception {
        assertEquals(1.0 + 1.0, exec("let x = 1.0; let y = 1.0; return x+y;"));
        assertEquals(1.0 + 2.0, exec("let x = 1.0; let y = 2.0; return x+y;"));
        assertEquals(5.0 + 10.0, exec("let x = 5.0; let y = 10.0; return x+y;"));
        assertEquals(1.0 + 1.0 + 2.0, exec("let x = 1.0; let y = 1.0; let z = 2.0; return x+y+z;"));
        assertEquals((1.0 + 1.0) + 2.0, exec("let x = 1.0; let y = 1.0; let z = 2.0; return (x+y)+z;"));
        assertEquals(1.0 + (1.0 + 2.0), exec("let x = 1.0; let y = 1.0; let z = 2.0; return x+(y+z);"));
        assertEquals(0.0 + 1.0, exec("let x = 0.0; let y = 1.0; return x+y;"));
        assertEquals(1.0 + 0.0, exec("let x = 1.0; let y = 0.0; return x+y;"));
        assertEquals(0.0 + 0.0, exec("let x = 0.0; let y = 0.0; return x+y;"));
    }
