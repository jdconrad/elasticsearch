...
public class DefEncodingTests extends ESTestCase {
    ...
    public void testParse() {
        ...
        assertEquals(
            new Def.Encoding(true, false, "org.elasticsearch.javascript.FeatureTestObject", "overloadedStatic", 0),
            new Def.Encoding("Sforg.elasticsearch.javascript.FeatureTestObject.overloadedStatic,0")
        );
    ...
    public void testValidate() {
        ...
        expected = expectThrows(
            IllegalArgumentException.class,
            () -> new Def.Encoding(true, true, "org.elasticsearch.javascript.FeatureTestObject", "overloadedStatic", 0)
        );

        assertThat(
            expected.getMessage(),
            startsWith("Def.Encoding symbol must be 'this', not [org.elasticsearch.javascript.FeatureTestObject] if needsInstance")
        );
