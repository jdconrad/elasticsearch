...
public class OverloadTests extends ScriptTestCase {
    ...
    public void testConstructor() {
        assertEquals(
            true,
            exec(
                "org.elasticsearch.javascript.FeatureTestObject f = new org.elasticsearch.javascript.FeatureTestObject();"
                    + "return f.x == 0 && f.y == 0;"
            )
        );
        assertEquals(
            true,
            exec(
                "org.elasticsearch.javascript.FeatureTestObject f = new org.elasticsearch.javascript.FeatureTestObject(1, 2);"
                    + "return f.x == 1 && f.y == 2;"
            )
        );
    }
    ...
    public void testStatic() {
        assertEquals(true, exec("return org.elasticsearch.javascript.FeatureTestObject.overloadedStatic();"));
        assertEquals(false, exec("return org.elasticsearch.javascript.FeatureTestObject.overloadedStatic(false);"));
    }
}
