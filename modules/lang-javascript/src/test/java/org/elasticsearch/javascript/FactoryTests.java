...
public class FactoryTests extends ScriptTestCase {
    ...
    protected Map<ScriptContext<?>, List<Whitelist>> scriptContexts() {
        ...
        contexts.put(StatefulFactoryTestScript.CONTEXT, JAVASCRIPT_BASE_WHITELIST);
        contexts.put(FactoryTestScript.CONTEXT, JAVASCRIPT_BASE_WHITELIST);
        contexts.put(DeterministicFactoryTestScript.CONTEXT, JAVASCRIPT_BASE_WHITELIST);
        contexts.put(EmptyTestScript.CONTEXT, JAVASCRIPT_BASE_WHITELIST);
        contexts.put(TemplateScript.CONTEXT, JAVASCRIPT_BASE_WHITELIST);
        contexts.put(VoidReturnTestScript.CONTEXT, JAVASCRIPT_BASE_WHITELIST);
        contexts.put(FactoryTestConverterScript.CONTEXT, JAVASCRIPT_BASE_WHITELIST);
        contexts.put(FactoryTestConverterScriptBadDef.CONTEXT, JAVASCRIPT_BASE_WHITELIST);
