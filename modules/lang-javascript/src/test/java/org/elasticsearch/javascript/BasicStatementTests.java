...
public class BasicStatementTests extends ScriptTestCase {
    ...
    public void testDeclarationStatement() {
        ...
        assertEquals(ArrayList[].class, exec("let a = new List[1]; return a;").getClass());
        assertEquals(List[].class, exec("let a = new JavaList[1]; return a;").getClass());
        ...
        assertEquals(ArrayList[][][].class, exec("let a = new List[1][2][3]; return a;").getClass());
        assertEquals(List[][][].class, exec("let a = new JavaList[1][2][3]; return a;").getClass());
