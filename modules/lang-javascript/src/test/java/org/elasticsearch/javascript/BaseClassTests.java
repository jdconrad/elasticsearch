...
/**
 * Tests for Javascript implementing different interfaces.
 */
public class BaseClassTests extends ScriptTestCase {

    protected Map<ScriptContext<?>, List<Whitelist>> scriptContexts() {
        Map<ScriptContext<?>, List<Whitelist>> contexts = new HashMap<>();
        contexts.put(Gets.CONTEXT, JAVASCRIPT_BASE_WHITELIST);
        contexts.put(NoArgs.CONTEXT, JAVASCRIPT_BASE_WHITELIST);
        contexts.put(OneArg.CONTEXT, JAVASCRIPT_BASE_WHITELIST);
        contexts.put(ArrayArg.CONTEXT, JAVASCRIPT_BASE_WHITELIST);
        contexts.put(PrimitiveArrayArg.CONTEXT, JAVASCRIPT_BASE_WHITELIST);
        contexts.put(DefArrayArg.CONTEXT, JAVASCRIPT_BASE_WHITELIST);
        contexts.put(ManyArgs.CONTEXT, JAVASCRIPT_BASE_WHITELIST);
        contexts.put(VarArgs.CONTEXT, JAVASCRIPT_BASE_WHITELIST);
        contexts.put(DefaultMethods.CONTEXT, JAVASCRIPT_BASE_WHITELIST);
        contexts.put(ReturnsVoid.CONTEXT, JAVASCRIPT_BASE_WHITELIST);
        contexts.put(ReturnsPrimitiveBoolean.CONTEXT, JAVASCRIPT_BASE_WHITELIST);
        contexts.put(ReturnsPrimitiveInt.CONTEXT, JAVASCRIPT_BASE_WHITELIST);
        contexts.put(ReturnsPrimitiveFloat.CONTEXT, JAVASCRIPT_BASE_WHITELIST);
        contexts.put(ReturnsPrimitiveDouble.CONTEXT, JAVASCRIPT_BASE_WHITELIST);
        contexts.put(NoArgsConstant.CONTEXT, JAVASCRIPT_BASE_WHITELIST);
        contexts.put(WrongArgsConstant.CONTEXT, JAVASCRIPT_BASE_WHITELIST);
        contexts.put(WrongLengthOfArgConstant.CONTEXT, JAVASCRIPT_BASE_WHITELIST);
        contexts.put(UnknownArgType.CONTEXT, JAVASCRIPT_BASE_WHITELIST);
        contexts.put(UnknownReturnType.CONTEXT, JAVASCRIPT_BASE_WHITELIST);
        contexts.put(UnknownArgTypeInArray.CONTEXT, JAVASCRIPT_BASE_WHITELIST);
        contexts.put(TwoExecuteMethods.CONTEXT, JAVASCRIPT_BASE_WHITELIST);
        return contexts;
    }
    ...
    public void testNoArgs() throws Exception {
        ...
        String debug = Debugger.toString(NoArgs.class, "int i = 0", new CompilerSettings(), JAVASCRIPT_BASE_WHITELIST);
    ...
    public void testManyArgs() throws Exception {
        ...
        // While we're here we can verify that javascript correctly finds used variables
    ...
    public void testReturnsVoid() throws Exception {
        ...
        String debug = Debugger.toString(ReturnsVoid.class, "int i = 0", new CompilerSettings(), JAVASCRIPT_BASE_WHITELIST);
    ...
    public void testReturnsPrimitiveBoolean() throws Exception {
        ...
        String debug = Debugger.toString(ReturnsPrimitiveBoolean.class, "false", new CompilerSettings(), JAVASCRIPT_BASE_WHITELIST);
    ...
    public void testReturnsPrimitiveInt() throws Exception {
        ...
        String debug = Debugger.toString(ReturnsPrimitiveInt.class, "1", new CompilerSettings(), JAVASCRIPT_BASE_WHITELIST);
    ...
    public void testReturnsPrimitiveFloat() throws Exception {
        ...
        String debug = Debugger.toString(ReturnsPrimitiveFloat.class, "1f", new CompilerSettings(), JAVASCRIPT_BASE_WHITELIST);
    ...
    public void testReturnsPrimitiveDouble() throws Exception {
        ...
        String debug = Debugger.toString(ReturnsPrimitiveDouble.class, "1", new CompilerSettings(), JAVASCRIPT_BASE_WHITELIST);
    ...
    public void testNoArgsConstant() {
        ...
        assertThat(
            e.getMessage(),
            startsWith(
                "Javascript needs a constant [String[] PARAMETERS] on all interfaces it implements with the "
    ...
    public void testUnknownArgType() {
        ...
        assertEquals(
            "[foo] is of unknown type ["
                ...
                + ". Javascript interfaces can only accept arguments "
    ...
    public void testUnknownReturnType() {
        ...
        assertEquals(
            "Javascript can only implement execute methods returning a whitelisted type but ["
    ...
    public void testUnknownArgTypeInArray() {
        ...
        assertEquals(
            "[foo] is of unknown type ["
                ...
                + ". Javascript interfaces can only accept "
    ...
    public void testTwoExecuteMethods() {
        ...
        assertEquals(
            "Javascript can only implement interfaces that have a single method named [execute] but ["
