...
/**
 * These tests run the Javascript scripts used in the context docs against
...
public class ContextExampleTests extends ScriptTestCase {
    ...
    */
    ...
    // Testing only params, as I am not sure how to test Script Doc Values in javascript
