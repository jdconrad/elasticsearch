 ...
 * within Javascript. Methods for Javascript classes may be accessed exactly as methods for Java classes
 * are using the '.' operator on an existing class variable/field. Javascript classes may have multiple
...
public class WhitelistMethod {
    ...
    public WhitelistMethod(
        ...
        List<Object> javascriptAnnotations
    ) {
