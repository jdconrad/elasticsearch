 ...
 * constructors, methods, and fields that can be used within a Javascript script at both compile-time
 * and run-time.
 *
 ...
 * {@link WhitelistField}s which are what will be available with a Javascript script.  See each individual
...
public final class Whitelist {
    ...
    /** The {@link List} of all the whitelisted Javascript classes. */
    public final List<WhitelistClass> whitelistClasses;

    /** The {@link List} of all the whitelisted static Javascript methods. */
    public final List<WhitelistMethod> whitelistImportedMethods;

    /** The {@link List} of all the whitelisted Javascript class bindings. */
    public final List<WhitelistClassBinding> whitelistClassBindings;

    /** The {@link List} of all the whitelisted Javascript instance bindings. */
